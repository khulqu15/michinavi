                                    ...
                                    <div v-if="data" class="space-y-3">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr class="hover" v-for="item, key in data" @click="setSelected(key)" :key="key">
                                                ...
                                                <th>
                                                    <ion-button @click="setSelected(key)" class="btn btn-ghost btn-xs text-base-content">details</ion-button>
                                                    <ion-button @click="setDelete(key)" class="btn btn-ghost btn-xs text-base-content">details</ion-button>
                                                </th>
                                            </tr>
                                            </tbody>
                                        </table>
