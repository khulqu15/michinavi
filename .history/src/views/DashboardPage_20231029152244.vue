                                        ...
                                        <div>
                                            <div class="bg-base-100 text-base-content p-6 rounded-3xl">
                                                <div class="flex items-center gap-x-4">
                                                    ...
                                                    <p>{{ data[dataSelected].width }}, {{ data[dataSelected].height }}</p>
                                                </div>
                                                ...
                                                <ion-button fill="clear" @click="setDelete(dataSelected)" class="btn w-full btn-error btn-xs">Delete</ion-button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
