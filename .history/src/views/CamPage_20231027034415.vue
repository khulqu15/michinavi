            ...
            <div class="modal-box max-w-2xl w-11/12 mx-auto">
                ...
                <div class="flex justify-between p-4 bg-gray-100 rounded-xl items-center">
                    <div class="relative">
                        ...
                        <div class="flex items-center gap-x-3"><Icon icon="heroicons:map-pin-20-solid" class="text-xl text-primary"/> <span class="text-2xl">(75.437282, 128.4739272)</span></div>
                    </div>
                </div>
            </div>
        </dialog>
