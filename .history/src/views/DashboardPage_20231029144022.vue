            ...
            <div class="bg-base-200 min-h-screen">
                <div class="grid grid-cols-12">
                    <div class="col-span-2">
                        <div class="drawer lg:drawer-open">
                            ...
                            <div class="drawer-side">
                                ...
                                <ul class="menu p-4 pt-8 space-y-3 bg-base-100 md:rounded-r-3xl relative rounded-none w-80 min-h-full text-base-content">
                                    <li>
                                    ...
                                    <li class="absolute bottom-0 inline-block -left-4 w-full p-6">
                                        <div class="grid grid-cols-2 hover:bg-base-100 active:bg-base-100 focus:bg-base-100">
                                            <button class="btn join-item">Light</button>
                                            <button class="btn join-item">Dark</button>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-span-10">
                        <div class="w-full flex justify-between items-center md:ml-6 bg-white p-6 rounded-bl-3xl">
                            <div>
                                <h4 class="font-semibold">Data Recorded</h4>
                            </div>
                            <div>
                        ...
                        <div class="w-full p-6 grid md:grid-cols-2 gap-6">
