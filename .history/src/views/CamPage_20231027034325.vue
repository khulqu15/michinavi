        ...
        <dialog id="option_modal" class="modal modal-bottom">
            <div class="modal-box max-w-2xl w-11/12 mx-auto">
                ...
                <div class="flex justify-between p-4 bg-gray-100 rounded-xl items-center">
                    <div class="relative">
                        <h4 class="font-semibold">Pothole (12, 4)</h4>
                        <div class="flex items-center gap-x-3"><Icon icon="heroicons:map-pin-20-solid" class="text-xl text-primary"/> (75.437282, 128.4739272)</div>
                    </div>
                </div>
            </div>
        </dialog>
