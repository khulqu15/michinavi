                    ...
                    <div v-if="cameras.length > 1">
                        ...
                        <dialog id="my_modal_2" class="modal">
                            <div class="modal-box p-0">
                                ...
                                <div class="space-y-2 max-w-[40vh] overflow-y-auto p-4 w-full">
                                    <div v-for="item in cameras" :key="item.deviceId" class="w-full bg-base-100 hover:bg-base-200 transition-all rounded-xl p-4">
                                        {{ item.label }}
                                    </div>
                                </div>
                            </div>
