      ...
      <ion-content :fullscreen="true">
        ...
        <div id="container" class="container mx-auto pb-6 mt-6 lg:px-0 px-8">
          ...
          <div class="flex items-center">
            <div class="max-w-lg w-full h-96 rounded-3xl bg-primary">
                <img src="/assets/images/illust1.jpg" class="w-full h-full object-center object-cover absolute top-0 left-0" alt="Image">
            </div>
          </div>
        </div>
