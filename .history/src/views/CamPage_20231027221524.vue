                    ...
                    <div v-if="cameras.length > 1">
                        ...
                        <dialog id="my_modal_2" class="modal">
                            <div class="modal-box p-0">
                                ...
                                <form method="dialog" class="space-y-2 max-h-[40vh] overflow-y-auto p-4 w-11/12 mx-auto">
                                    <ion-button fill="clear" v-for="item in cameras" :key="item.deviceId" class="w-full hover:bg-base-200 transition-all rounded-xl p-4"
