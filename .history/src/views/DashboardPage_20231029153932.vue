                    ...
                    <div class="col-span-10">
                        ...
                        <div class="max-h-[88vh] overflow-y-auto">
                            <div class="w-full p-6">
                                ...
                                <div v-else>
                                    <div v-if="data" class="gap-6 grid grid-cols-2">
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>
                                                        <label>
                                                            <input id="select_all" type="checkbox" class="checkbox" v-model="selectAll" @input="toggleSelectAll()"/>
                                                        </label>
                                                        </th>
                                                        <th>Name</th>
                                                        <th>Dimension</th>
