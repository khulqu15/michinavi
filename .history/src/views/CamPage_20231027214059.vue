            ...
            <dialog id="back_modal" class="modal">
                <div class="modal-box">
                    ...
                    <div class="grid grid-cols-3 gap-x-4">
                        ...
                        <ion-button router-link="/home" router-direction="forward" class="btn w-full normal-case" :class="{'bg-black text-white': theme == 'light', 'bg-white text-black': theme == 'dark'}" fill="clear">Back</ion-button>
                        <ion-button @click="stopStream()" class="btn btn-error normal-case" fill="clear">Stop</ion-button>
                    </div>
                </div>
            </dialog>
        </div>
