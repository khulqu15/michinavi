        ...
        <div>
            <div id="container" class="relative min-h-screen overflow-hidden">
                ...
                <div class="absolute top-0 left-0 p-3 rounded-br-3xl inline-block bg-base-100">
                    <ion-button fill="clear" router-direction="forward" class="btn rounded-xl btn-sm px-0"
                ...
                <div class="p-4 absolute top-0 right-0 bg-base-100/10 flex items-center rounded-bl-3xl backdrop-blur-lg inline-block">
                    ...
                    <div>
                        <ion-button fill="clear" onclick="back_modal.showModal()" size="small" class="btn px-0 rounded-xl border-0"
