        ...
        <div class="fixed w-full h-full flex items-center justify-center bg-base-200 z-20 transition-all" :class="{'-left-[100%] opacity-0 invisible': emailLocal, 'left-0 top-0': !emailLocal}">
            <div class="max-w-md w-full p-6 rounded-3xl">
                <form @submit.prevent="submitUserForm" class="text-2xl">
                    ...
                    <ion-button type="submit" fill="clear" class="btn bg-black text-white mt-6">Demo</ion-button>
                </form>
            </div>
        </div>
        <div>
            <div id="container" class="relative min-h-screen overflow-hidden">
                ...
                <div class="p-4 absolute top-0 right-0 bg-base-100/10 flex items-center rounded-bl-3xl backdrop-blur-lg inline-block">
                    ...
                    <div>
                        <ion-button fill="clear" onclick="emailLocal = null" size="small" class="btn px-0 rounded-xl border-0"
            ...
            <dialog id="back_modal" class="modal">
                <div class="modal-box">
                    ...
                    <div class="grid grid-cols-3 gap-x-4">
                        <ion-button class="btn btn-ghost w-full normal-case" fill="clear">Just Back</ion-button>
                        <ion-button class="btn w-full normal-case" fill="clear">Just Back</ion-button>
                        <ion-button class="btn w-full normal-case" :class="{'bg-black text-white': theme == 'light', 'bg-white text-black': theme == 'dark'}" fill="clear">Stop Detection</ion-button>
                    </div>
                </div>
            </dialog>
        </div>
