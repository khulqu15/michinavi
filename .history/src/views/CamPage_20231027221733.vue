                        ...
                        <dialog id="my_modal_2" class="modal">
                            <div class="modal-box p-0">
                                ...
                                <form method="dialog" class="space-y-2 max-h-[40vh] overflow-y-auto p-4 w-full overflow-x-hidden">
                                    <ion-button type="submit" @click="camera = item.deviceId" fill="clear" v-for="item in cameras" :key="item.deviceId" class="w-full hover:bg-base-200 text-base-content transition-all rounded-xl p-4"
