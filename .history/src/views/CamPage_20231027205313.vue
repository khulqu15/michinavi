            ...
            <div class="max-w-md w-full p-6 rounded-3xl">
                <form @submit.prevent="submitUserForm" class="text-2xl">
                    <div class="form-control space-y-3">
                        <label for="email" class="text-base-content/50">Email Address</label>
                        <input v-model="email" type="email" required class="input w-full bg-base-100">
                    </div>
                    <ion-button fill="clear" class="btn bg-black text-white mt-6">Start Demo</ion-button>
                </form>
            </div>
        </div>
        <div>
